/*
  ...
  - Added the required column `section` to the `shifts` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_shifts" ("createdAt", "createdById", "departureTime", "dutyHours", "dutyType", "id", "lobbySignOff", "lobbySignOn", "locoPilotId", "locomotiveId", "reliefPlanned", "reliefReason", "reliefRequired", "reliefTime", "signOffDate", "signOffStation", "signOffTime", "signOnStation", "signOnTime", "status", "timeOfTO", "trainArrivalDate", "trainArrivalTime", "trainManagerId", "trainName", "trainNumber", "updatedAt", "updatedById", "section") SELECT "createdAt", "createdById", "departureTime", "dutyHours", "dutyType", "id", "lobbySignOff", "lobbySignOn", "locoPilotId", "locomotiveId", "reliefPlanned", "reliefReason", "reliefRequired", "reliefTime", "signOffDate", "signOffStation", "signOffTime", "signOnStation", "signOnTime", "status", "timeOfTO", "trainArrivalDate", "trainArrivalTime", "trainManagerId", "trainName", "trainNumber", "updatedAt", "updatedById", 'UNKNOWN' FROM "shifts";
DROP TABLE "shifts";
